...
int main() {
    ...
    const auto initial_local_values_per_row =
            rank == 0 ? global_num_rows / initial_num_processors_per_row : 0;
    const auto initial_local_values_per_col =
            rank == 0 ? global_num_cols / initial_num_processors_per_col : 0;
    ...
    auto initial_layout = costa::block_cyclic_layout(
            ...
            global_num_cols, initial_local_data_ordering, rank);
